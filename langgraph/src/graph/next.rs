...
//!
//! Design: docs/rust-langgraph/11-state-graph-design.md (conditional edges),
//! docs/rust-langgraph/13-react-agent-design.md §8.5 stage 5.1. The graph runner uses this to decide the next node or to stop.
