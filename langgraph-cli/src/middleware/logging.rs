...
//!
//! Used by [`WithNodeLogging`](super::WithNodeLogging) and the run pipeline.
//! Interacts with [`NodeMiddleware`](langgraph::NodeMiddleware) and [`ReActState`](langgraph::ReActState).
